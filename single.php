<?php get_header();?>
		<div id="content" class="clear">
			...
			<div id="postnavi" class="maincolum clear hor_side"><?php 
		if (get_previous_post()) { 
			  previous_post_link('<span class="left prev_post icon">%link</span>');
 		} else {
    			echo "<span class=\"left prev_post icon\">已经是最后一篇啦</span>";
 		}	
		if (get_next_post()) { 
			  next_post_link('<span class="right next_post icon">%link</span>');
 		} else {
    			echo "<span class=\"right next_post icon\">已经是第一篇啦</span>";
 		}		
		?></div>
